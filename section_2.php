<section class="text-white" style="background-color: #000000; padding-bottom: 3em">
    <div class="container px-4 px-lg-5">
        ...
        <div class="col-lg-12 text-center" style="margin-top: 15px">
            ...
            <br>
            <a href="https://eduardo-aguila.mykajabi.com/offers/5Q3wuoBf/checkout" class="button" data-aos="zoom-in" style="border-radius: 30px;" data-aos-delay="300">QUIERO MEJORAR YA</a>
       </div>
    </div>
