...
<section class=" text-white" style="background-color: #000000 ; padding: 2em 0">
    <div class="container px-4 px-lg-5">
        ...
        <div id="vidalytics_embed_K6wPDwSa57UJnsvq" style="width: 100%; position:relative; padding-top: 56.25%;"  data-aos="zoom-int" data-aos-delay="300"></div>
        <script type="text/javascript">
            ...
            })(window, document, 'Vidalytics', 'vidalytics_embed_K6wPDwSa57UJnsvq', 'https://fast.vidalytics.com/embeds/IylvwGx2/K6wPDwSa57UJnsvq/');
        </script>
...
<section class="text-white" style="background-color: #000000; padding-bottom: 3em">
    <div class="container px-4 px-lg-5">
        ...
        <div class="col-lg-12 text-center" style="margin-top: 15px">
            <h1 style="font-size: 2.5em; color: #ff4c4c" class="mb-4" data-aos="fade-right" data-aos-delay="300">¿Sabías que más del 70% de las personas intentan
                transformar su físico cada año, pero pocas lo logran de manera saludable?</h1>
            <h1 style="font-size: 1.1em; font-family: 'Roboto', sans-serif;" data-aos="fade-right" data-aos-delay="300">En Kaizen Elite, te enseñamos cómo conseguir el físico que deseas sin tonterias con nuestro Sistema
